...
public class Claim {
    ...
    @Column(name = "adjusting_office_code")
    ...
    @Column(name = "master_claim")
    private String masterClaim;
    
    @Column(name = "affiliate_claim_number")
    private String affiliateClaimNumber;
    
    @Column(name = "jurisdiction_claim_number")
    ...
    public LocalDateTime getIncidentReportedDate() { return incidentReportedDate; }
    public void setIncidentReportedDate(LocalDateTime incidentReportedDate) { this.incidentReportedDate = incidentReportedDate; }
    
    public LocalDateTime getClaimClosedDate() { return claimClosedDate; }
    public void setClaimClosedDate(LocalDateTime claimClosedDate) { this.claimClosedDate = claimClosedDate; }
